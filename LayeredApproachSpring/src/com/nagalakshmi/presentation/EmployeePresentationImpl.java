...
public class EmployeePresentationImpl implements EmployeePresentation {
	...
	public EmployeePresentationImpl(EmployeeService employeeService, ProjectAllocationService projectAllocService) {
		super();
		this.employeeService = employeeService;
		this.projectAllocService = projectAllocService;
	}
	...
	private ProjectAllocationService projectAllocService;
	
	
	public void setProjectAllocService(ProjectAllocationService projectAllocService) {
		this.projectAllocService = projectAllocService;
	}
